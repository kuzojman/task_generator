...
def task_14():
    ...
    скорости лодки?"""
    vehicle = random.sample(generate_context('./xfinity/context.json', 'vehicle'), 1)[0]
    while True:
...
def task_38():
    ...
    vehicle = random.sample(generate_context('./xfinity/context.json', 'vehicle'), 1)[0]
    raft = random.sample(generate_context('./xfinity/context.json', 'raft'), 1)[0]
    water = random.sample(generate_context('./xfinity/context.json', 'water'), 1)[0]
    while True:
...
def task_2604():
    ...
    actor = random.sample(generate_context('./xfinity/context.json', 'actor'), 1)[0]
    vehicle = random.sample(generate_context('./xfinity/context.json', 'vehicle'), 1)[0]
    water =  random.sample(generate_context('./xfinity/context.json', 'water'), 1)[0]
...
def task_3881():
    ...
    vehicle = random.sample(generate_context('./xfinity/context.json', 'vehicle'), 1)[0]
    raft = random.sample(generate_context('./xfinity/context.json', 'raft'), 1)[0]
    dest_a, dest_b = random.sample(generate_context('./xfinity/context.json', 'destination'), 1)[0]
    while True:
